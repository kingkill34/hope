...
public class HopeSqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
	...
	private String environment = HopeSqlSessionFactoryBean.class.getSimpleName(); // EnvironmentAware
																					// requires
																					// spring
																					// 3.1
	...
	private void hopeTypeAliasesElement(TypeAliasRegistry typeAliasRegistry) {
		typeAliasRegistry.registerAlias("paramsMap", Params.class);
	}
	...
	protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
		...
		HopeXmlConfigBuilder xmlConfigBuilder = null;
		if (this.configLocation != null) {
			xmlConfigBuilder = new HopeXmlConfigBuilder(this.configLocation.getInputStream(), null, this.configurationProperties);
		...
		hopeTypeAliasesElement(configuration.getTypeAliasRegistry());
